               ...
               .patches =
                  {
                     ...
                     patch{0x61f880 + 0x1, 0x64, 0x7f, {.values_are_8bit = true}}, // preShadowTransparentItemSize 8-bit signed int, needs relocating to increase it
                  },
            },
               ...
               .patches =
                  {
                     ...
                     patch{0x41d38c + 0x1, 0x64, 0x7f, {.values_are_8bit = true}}, // SetClassMaxCost::MaxCount    - soldierClass (2) 8-bit signed int, needs relocating to increase it
               ...
               .patches =
                  {
                     ...
                     patch{0x405ce7 + 0x2, 0x800, 0x8000, {.file_offset = true}},
               ...
               .patches =
                  {
                     ...
                     patch{0x4106d5 + 0x3, 0xde81c4, renderItemPool_address + 52, {.expected_is_va = true}},
                     patch{0x4106dc + 0x3, 0xde8194, renderItemPool_address + 4, {.expected_is_va = true}},
